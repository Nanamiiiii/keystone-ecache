...
class KeystoneDevice {
 ...
 public:
  ...
  Error createCache(uint64_t minPages, uint64_t utm_size);
    bool copyCachedEnclave(struct runtime_params_t params,
  ...
  Error cacheFinalize(
    uintptr_t runtimePhysAddr, uintptr_t eappPhysAddr, uintptr_t freePhysAddr,
    struct runtime_params_t params, unsigned char *sign, unsigned char *pub_key, unsigned char *cert);
  virtual Error destroy();
  virtual Error resetcache();
