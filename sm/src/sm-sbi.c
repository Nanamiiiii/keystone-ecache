...
unsigned long sbi_sm_create_cache(unsigned long* eid, uintptr_t create_args)
{
  struct keystone_sbi_create create_args_local;
  unsigned long ret;
  ...
  ret = create_cache(eid, create_args_local);
  return ret;
}

unsigned long sbi_sm_copy_cached_enclave(unsigned long* eid, uintptr_t create_args)
{
  struct keystone_sbi_create create_args_local;
  unsigned long ret;
  ...
  ret = copy_cached_enclave(eid, create_args_local);
  return ret;
}
...
unsigned long sbi_sm_reset_cache()
{
  unsigned long ret;
  ret = reset_cache();
  return ret;
